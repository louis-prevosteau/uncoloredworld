...
export class Monde1 {
  private game: ColoredLevel;
  private tilemap;
  private TileA2;
  private tileset01c;
  private RPGNatureTileset;
  private buildatlasc;
  private tux01c;
  ...
  constructor(game: any) {
    this.game = game;
    // Texture MAP
    this.tilemap = this.game.make.tilemap({key: 'level2'});
    this.tileset01c = this.tilemap.addTilesetImage('tileset01', 'tileset01c');
    this.buildatlasc = this.tilemap.addTilesetImage('build_atlas', 'build_atlasc');
    this.tux01c = this.tilemap.addTilesetImage('tux01', 'tux01c');

    // Chargement des calques
    this.HerbeCStileset01 = this.tilemap.createStaticLayer('Herbe-CStileset01', this.tileset01c, 0, 0);
    this.CheminCStileset01 = this.tilemap.createStaticLayer('Chemin-CStileset01', this.tileset01c, 0, 0);
    this.PoseVaisseauCStileset01 = this.tilemap.createStaticLayer('PoseVaisseauCS-tileset01', this.tileset01c, 0, 0);
    this.VaisseauxCStux01 = this.tilemap.createStaticLayer('Vaisseaux-CStux01', this.tux01c, 0, 0);
    this.DecoCStileset01 = this.tilemap.createStaticLayer('Deco-CStileset01', this.tileset01c, 0, 0);
    this.Deco2CStileset01 = this.tilemap.createStaticLayer('Deco2-CStileset01', this.tileset01c, 0, 0);
    this.BassinCStileset01 = this.tilemap.createStaticLayer('Bassin-CStileset01', this.tileset01c, 0, 0);
    this.BatimentsCSbuildatlas = this.tilemap.createStaticLayer('Batiments-CSbuild_atlas', this.buildatlasc, 0, 0);
    this.PortesCSbuildatlas = this.tilemap.createStaticLayer('Portes-CSbuild_atlas', this.buildatlasc, 0, 0);
    this.EscaliersDePorteCSbuildatlas = this.tilemap.createStaticLayer('EscaliersDePorte-CSbuild_atlas', this.buildatlasc, 0, 0);
    this.ToitsCSbuildatlas = this.tilemap.createStaticLayer('Toits-CSbuild_atlas', this.buildatlasc, 0, 0);
    this.ChemineeCSbuildatlas = this.tilemap.createStaticLayer('Cheminee-CSbuild_atlas', this.buildatlasc, 0, 0);
